...
//    public String updateAgent(@ModelAttribute("agentList") AgentCollectionModel agentList, BindingResult bindingResult) {
//        if (bindingResult.hasErrors()) {
//            return "redirect:/home";
//        }
//        System.out.println(agentList.getAccountCode()+"           "+agentList.getCollectionAmount());
//        
