...
@Entity
@Table(name = "CUSTOMER_DENOMINATION_VIEW", schema = "CUSTOMER")
public class DenominationViewEntity {
	...
	public void setNoOfNotes(Long noOfNotes) {
