...
@Entity
@Table(name = "AGENT_DAILY_DENOMINATION", schema = "CUSTOMER")
public class DenominationSummaryEntity {
	...
	@Column(name = "offlineamt")
	private Long offlineAmt;

	@Column(name = "totalamount")
	private Long totalAmount;
	@Column(name = "changereturn")
	...
	public void setChangeReturn(Long changeReturn) {
