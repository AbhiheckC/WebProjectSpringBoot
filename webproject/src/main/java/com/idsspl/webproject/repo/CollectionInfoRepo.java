...
public interface CollectionInfoRepo extends JpaRepository<CollectionInfoEntity, String>{ 
	...
	@Query("SELECT a FROM CollectionInfoEntity a WHERE a.agentName = :agentName and a.collectionDate = :collectionDate and a.multipleDenominationno = 0 and a.isMultipleDenomination ='Y' and a.paymentMethod = 'Offline' ")
