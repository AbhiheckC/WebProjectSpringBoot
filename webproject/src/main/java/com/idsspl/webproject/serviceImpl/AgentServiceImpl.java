...
//	@Override
//	public List<AgentCollectionModel> getCollectionList(AgentCollectionModel collection) {
//		List<AgentCollectionEntity> agentCollectionEntityList = null;
//		System.out.println("collection date -------------"+collection.getCollectionDate());
//		agentCollectionEntityList = agentCollectionRepo.findByCustomerIdAndCollectionDate(collection.getCustomerId(), collection.getCollectionDate(),collection.getReceiptNo());
//		
//		List<AgentCollectionModel> agentCollectionModelList = new ArrayList<>();
//
//		agentCollectionEntityList.stream().forEach(collectionEntity -> {
//			AgentCollectionModel collectionModel = new AgentCollectionModel();
